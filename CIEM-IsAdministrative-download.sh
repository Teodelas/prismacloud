...
REPORT_LOCATION="$HOME/reports/CIEM_IsAdministrative_$REPORT_DATE.csv"
...
query_prismacloud(){
    ...
    {
    "query": "config from iam where source.cloud.type = 'AWS' AND action.access.isadministrative = true", 
