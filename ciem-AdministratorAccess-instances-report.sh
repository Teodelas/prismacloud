...
REPORT_LOCATION="$HOME/reports/AdministratorAccess_policy_Usage_EC2_Instances_$REPORT_DATE.csv"
...
{
    "query": "config from iam where source.cloud.type = 'AWS' and source.cloud.resource.type = 'instance' AND grantedby.cloud.policy.name = 'AdministratorAccess'", 
